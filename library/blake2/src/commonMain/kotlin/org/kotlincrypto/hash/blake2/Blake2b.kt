 ...
 */
public class Blake2b : Blake2 {
    public companion object {
        private const val MAX_DIGEST_BITS_LENGTH = 512
    ...
    override val roundsInCompress: Int = 12
    override val sizeBytes: Int = Long.SIZE_BYTES
    override val r1: Int = 32
    override val r2: Int = 24
    override val r3: Int = 16
    override val r4: Int = 63

    override val blakeIV: Array<Blake2Word>
        get() = arrayOf(
            Blake2Word.Blake2bWord(0x6a09e667f3bcc908L),
            Blake2Word.Blake2bWord(-0x4498517a7b3558c5L),
            Blake2Word.Blake2bWord(0x3c6ef372fe94f82bL),
            Blake2Word.Blake2bWord(-0x5ab00ac5a0e2c90fL),
            Blake2Word.Blake2bWord(0x510e527fade682d1L),
            Blake2Word.Blake2bWord(-0x64fa9773d4c193e1L),
            Blake2Word.Blake2bWord(0x1f83d9abfb41bd6bL),
            Blake2Word.Blake2bWord(0x5be0cd19137e2179L),
        )
    ...
    override fun createM(input: ByteArray, offset: Int): Array<Blake2Word> {
        val m = Array<Blake2Word>(16) { Blake2Word.Blake2bWord(0) }
        for (j in 0..15) {
            var startIndex = offset + j * sizeBytes
            m[j] = Blake2Word.Blake2bWord(
                bytesToLong(
                    input[startIndex],
                    input[++startIndex],
                    input[++startIndex],
    ...
    override fun createWord(value: Long): Blake2Word = Blake2Word.Blake2bWord(value)
}
